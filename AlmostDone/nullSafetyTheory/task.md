...
The `!!` operator simply disregards the possibility of a `null` value and treats the type as though it cannot be `null`. 
However, if the program encounters the `null` value,
